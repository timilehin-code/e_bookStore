<?php
require '../processors/adminLogin.php';
$msg = '';
if (isset($_GET['reg'])) {
    $msg ="<div class='alert alert-success text-center mt-2'>Registration successful</div>";
}
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="container form-width-3 mt-3">
        <div class="note centralize">
            ...
            <form action="" method="POST">
                ...
                <button type="login" name="login" class="btn btn-info w-100 mt-3">Log in</button>
            </form>
